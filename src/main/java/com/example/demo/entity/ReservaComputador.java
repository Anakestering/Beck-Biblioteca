...
@NoArgsConstructor
@Entity
@Table(name = "reserva_computador", indexes = {
    @Index(name = "idx_rc_ativo_status_checkin",  columnList = "ativo, status, checkin_em, checkout_em"),
    @Index(name = "idx_rc_ativo_status_inicio",   columnList = "ativo, status, inicio_previsto"),
    @Index(name = "idx_rc_heatmap",               columnList = "usuario_id, computador_id, checkin_em, inicio_previsto, status, ativo"),
})
